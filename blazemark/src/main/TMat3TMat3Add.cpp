...
//  \brief Source file for the 3-dimensional transpose matrix/transpose matrix addition benchmark
//
...
#include <blazemark/flens/TMat3TMat3Add.h>
#include <blazemark/gmm/TMat3TMat3Add.h>
#include <blazemark/mtl/TMat3TMat3Add.h>
...
// transpose matrix/transpose matrix addition benchmark.
*/
...
//*************************************************************************************************
/*!\brief 3-dimensional transpose matrix/transpose matrix addition benchmark function.
//
// \param runs The specified benchmark runs.
// \param benchmarks The selection of benchmarks.
// \return void
*/
void tmat3tmat3add( std::vector<Run>& runs, Benchmarks benchmarks )
{
   std::cout << std::left;
   ...
   if( benchmarks.runBlaze ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         ...
         run->setBlazeResult( blazemark::blaze::tmat3tmat3add( N, steps ) );
   ...
   if( benchmarks.runBoost ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         const size_t N    ( run->getNumber() );
         const size_t steps( run->getSteps()  );
         run->setBoostResult( blazemark::boost::tmat3tmat3add( N, steps ) );
         const double mflops( 9UL * steps / run->getBoostResult() / 1E6 );
         std::cout << "     " << std::setw(12) << N << mflops << std::endl;
      }
   }
   ...
   if( benchmarks.runBlitz ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         const size_t N    ( run->getNumber() );
         const size_t steps( run->getSteps()  );
         run->setBlitzResult( blazemark::blitz::tmat3tmat3add( N, steps ) );
         const double mflops( 9UL * steps / run->getBlitzResult() / 1E6 );
         std::cout << "     " << std::setw(12) << N << mflops << std::endl;
      }
   }
#endif
   ...
   if( benchmarks.runGMM ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         const size_t N    ( run->getNumber() );
         const size_t steps( run->getSteps()  );
         run->setGMMResult( blazemark::gmm::tmat3tmat3add( N, steps ) );
         const double mflops( 9UL * steps / run->getGMMResult() / 1E6 );
         std::cout << "     " << std::setw(12) << N << mflops << std::endl;
      }
   }
#endif
   ...
   if( benchmarks.runArmadillo ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         const size_t N    ( run->getNumber() );
         const size_t steps( run->getSteps()  );
         run->setArmadilloResult( blazemark::armadillo::tmat3tmat3add( N, steps ) );
   ...
   if( benchmarks.runFLENS ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         const size_t N    ( run->getNumber() );
         const size_t steps( run->getSteps()  );
         run->setFLENSResult( blazemark::flens::tmat3tmat3add( N, steps ) );
         const double mflops( 9UL * steps / run->getFLENSResult() / 1E6 );
         std::cout << "     " << std::setw(12) << N << mflops << std::endl;
      }
   }
#endif
   ...
   if( benchmarks.runMTL ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         const size_t N    ( run->getNumber() );
         const size_t steps( run->getSteps()  );
         run->setMTLResult( blazemark::mtl::tmat3tmat3add( N, steps ) );
         const double mflops( 9UL * steps / run->getMTLResult() / 1E6 );
         std::cout << "     " << std::setw(12) << N << mflops << std::endl;
      }
   }
#endif
   ...
   if( benchmarks.runEigen ) {
      ...
      for( std::vector<Run>::iterator run=runs.begin(); run!=runs.end(); ++run ) {
         const size_t N    ( run->getNumber() );
         const size_t steps( run->getSteps()  );
         run->setEigenResult( blazemark::eigen::tmat3tmat3add( N, steps ) );
...
//*************************************************************************************************
/*!\brief The main function for the 3-dimensional transpose matrix/transpose matrix addition
//        benchmark.
//
...
int main( int argc, char** argv )
{
   ...
   const std::string parameterFile( installPath + "/params/tmat3tmat3add.prm" );
   Parser<Run> parser;
   std::vector<Run> runs;
