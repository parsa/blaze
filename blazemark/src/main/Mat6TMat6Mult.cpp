...
void estimateSteps( DenseRun& run )
{
   ...
   blaze::StaticMatrix<real,6UL,6UL,rowMajor> init( 0.1 );
   std::vector< blaze::StaticMatrix<real,6UL,6UL,rowMajor> > A( N, init ), C( N );
   std::vector< blaze::StaticMatrix<real,6UL,6UL,columnMajor> > B( N, init );
