...
void estimateSteps( DenseRun& run )
{
   ...
   std::vector< blaze::StaticMatrix<real,3UL,3UL,rowMajor> > A( N, init ), C( N );
   std::vector< blaze::StaticMatrix<real,3UL,3UL,columnMajor> > B( N, init );
...
// \return void
*/
void mat3tmat3mult( std::vector<DenseRun>& runs, Benchmarks benchmarks )
{
   std::cout << std::left;
