//=================================================================================================
/*!
//  \file src/blaze/TMat3Mat3Mult.cpp
...
void estimateSteps( DenseRun& run )
{
   ...
   std::vector< blaze::StaticMatrix<element_t,3UL,3UL,columnMajor> > A( N, init ), C( N );
   std::vector< blaze::StaticMatrix<element_t,3UL,3UL,rowMajor> > B( N, init );
...
// \return void
*/
void tmat3mat3mult( std::vector<DenseRun>& runs, Benchmarks benchmarks )
{
   std::cout << std::left;
