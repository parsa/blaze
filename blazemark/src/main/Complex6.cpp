...
void estimateSteps( DenseRun& run )
{
   ...
   blaze::DynamicMatrix<element_t,columnMajor> A( N, N, 0.1 ), B( N, N, 0.1 ), C( N, N, 0.1 ), D( N, N );
...
// \return void
*/
void complex6( std::vector<DenseRun>& runs, Benchmarks benchmarks )
{
   std::cout << std::left;
...
int main( int argc, char** argv )
{
   ...
   const std::string parameterFile( installPath + "/params/complex6.prm" );
