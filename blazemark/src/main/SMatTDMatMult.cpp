//=================================================================================================
/*!
//  \file src/blaze/SMatTDMatMult.cpp
//  \brief Source file for the sparse matrix/transpose dense matrix multiplication benchmark
//
...
#include <blazemark/blaze/SMatTDMatMult.h>
...
//*************************************************************************************************
/*!\brief Sparse matrix/transpose dense matrix multiplication benchmark function.
//
// \param runs The specified benchmark runs.
// \param benchmarks The selection of benchmarks.
// \return void
*/
void smattdmatmult( std::vector<SparseRun>& runs, Benchmarks benchmarks )
{
   std::cout << std::left;
...
//*************************************************************************************************
/*!\brief The main function for the sparse matrix/transpose dense matrix multiplication benchmark.
//
...
int main( int argc, char** argv )
{
   ...
   const std::string parameterFile( installPath + "/params/smattdmatmult.prm" );
