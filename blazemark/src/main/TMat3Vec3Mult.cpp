...
void estimateSteps( DenseRun& run )
{
   ...
   blaze::StaticMatrix<real,3UL,3UL,rowMajor> mat( 0.1 );
   blaze::StaticVector<real,3UL,columnVector> vec( 0.1 );
   std::vector< blaze::StaticMatrix<real,3UL,3UL,rowMajor> > A( N, mat );
   std::vector< blaze::StaticVector<real,3UL,columnVector> > a( N, vec ), b( N );
