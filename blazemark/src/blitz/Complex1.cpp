//=================================================================================================
/*!
//  \file src/blitz/Complex1.cpp
//  \brief Source file for the Blitz++ kernel for the complex expression c = A * ( a + b )
//
...
//*************************************************************************************************
/*!\brief Blitz++ kernel for the complex expression c = A * ( a + b ).
//
...
double complex1( size_t N, size_t steps )
{
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Blitz++ kernel 'complex1': Time deviation too large!!!\n";
