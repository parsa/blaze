//=================================================================================================
/*!
//  \file src/gmm/DVecScalarMult.cpp
//  \brief Source file for the GMM++ dense vector/scalar multiplication kernel
//
...
//*************************************************************************************************
/*!\brief GMM++ dense vector/scalar multiplication kernel.
//
...
double dvecscalarmult( size_t N, size_t steps )
{
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " GMM++ kernel 'dvecscalarmult': Time deviation too large!!!\n";
