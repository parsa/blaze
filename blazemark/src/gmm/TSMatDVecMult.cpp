//=================================================================================================
/*!
//  \file src/gmm/TSMatDVecMult.cpp
//  \brief Source file for the GMM++ transpose sparse matrix/dense vector multiplication kernel
//
...
//*************************************************************************************************
/*!\brief GMM++ transpose sparse matrix/dense vector multiplication kernel.
//
...
double tsmatdvecmult( size_t N, size_t F, size_t steps )
{
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " GMM++ kernel 'tsmatdvecmult': Time deviation too large!!!\n";
