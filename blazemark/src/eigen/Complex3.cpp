...
//*************************************************************************************************
/*!\brief Eigen kernel for the complex expression c = A * B * ( a + b ).
//
...
double complex3( size_t N, size_t steps )
{
   ...
   ::Eigen::Matrix<real,Dynamic,Dynamic,ColMajor> A( N, N ), B( N, N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Eigen kernel 'complex3': Time deviation too large!!!\n";
