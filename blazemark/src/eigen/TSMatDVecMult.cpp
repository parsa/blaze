//=================================================================================================
/*!
//  \file src/eigen/TSMatDVecMult.cpp
//  \brief Source file for the Eigen transpose sparse matrix/dense vector multiplication kernel
//
...
//*************************************************************************************************
/*!\brief Eigen transpose sparse matrix/dense vector multiplication kernel.
//
...
double tsmatdvecmult( size_t N, size_t F, size_t steps )
{
   ...
   ::Eigen::SparseMatrix<real,ColMajor,EigenSparseIndexType> A( N, N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Eigen kernel 'tsmatdvecmult': Time deviation too large!!!\n";
