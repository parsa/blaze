//=================================================================================================
/*!
//  \file src/eigen/Vec3Vec3Add.cpp
//  \brief Source file for the Eigen 3D vector/vector addition kernel
//
...
//*************************************************************************************************
/*!\brief Eigen 3-dimensional vector/vector addition kernel.
//
...
double vec3vec3add( size_t N, size_t steps )
{
   ...
   ::std::vector< ::Eigen::Matrix<real,3,1> > a( N ), b( N ), c( N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Eigen kernel 'vec3vec3add': Time deviation too large!!!\n";
