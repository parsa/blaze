//=================================================================================================
/*!
//  \file src/classic/DMatDVecMult.cpp
//  \brief Source file for the classic dense matrix/dense vector multiplication kernel
//
...
//*************************************************************************************************
/*!\brief Classic dense matrix/dense vector multiplication kernel.
//
...
double dmatdvecmult( size_t N, size_t steps )
{
   ...
   ::blazemark::classic::Matrix<real,false> A( N, N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Classic kernel 'dmatdvecmult': Time deviation too large!!!\n";
