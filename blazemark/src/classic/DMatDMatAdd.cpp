//=================================================================================================
/*!
//  \file src/classic/DMatDMatAdd.cpp
//  \brief Source file for the classic dense matrix/dense matrix addition kernel
//
...
//*************************************************************************************************
/*!\brief Classic dense matrix/dense matrix addition kernel.
//
...
double dmatdmatadd( size_t N, size_t steps )
{
   ...
   ::blazemark::classic::Matrix<real,false> A( N, N ), B( N, N ), C( N, N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Classic kernel 'dmatdmatadd': Time deviation too large!!!\n";
