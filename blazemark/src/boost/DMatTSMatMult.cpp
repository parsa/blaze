...
#include <blazemark/boost/DMatTSMatMult.h>
...
//*************************************************************************************************
/*!\brief Boost uBLAS dense matrix/transpose sparse matrix multiplication kernel.
//
...
//
// This kernel function implements the dense matrix/transpose sparse matrix multiplication by
// means of the Boost uBLAS functionality.
*/
double dmattsmatmult( size_t N, size_t F, size_t steps )
{
   ...
   ::boost::numeric::ublas::matrix<real,row_major> A( N, N ), C( N, N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Boost uBLAS kernel 'dmattsmatmult': Time deviation too large!!!\n";
