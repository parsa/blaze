//=================================================================================================
/*!
//  \file src/boost/Complex4.cpp
//  \brief Source file for the Boost kernel for the complex expression b += s * A * a
//
...
//*************************************************************************************************
/*!\brief Boost uBLAS kernel for the complex expression b += s * A * a.
//
...
double complex4( size_t N, size_t steps )
{
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Boost uBLAS kernel 'complex4': Time deviation too large!!!\n";
