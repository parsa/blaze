//=================================================================================================
/*!
//  \file src/boost/Mat6Mat6Mult.cpp
//  \brief Source file for the Boost 6D matrix/matrix multiplication kernel
//
...
//*************************************************************************************************
/*!\brief Boost uBLAS 6-dimensional matrix/matrix multiplication kernel.
//
...
double mat6mat6mult( size_t N, size_t steps )
{
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Boost uBLAS kernel 'mat6mat6mult': Time deviation too large!!!\n";
