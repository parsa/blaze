//=================================================================================================
/*!
//  \file src/mtl/Vec3Vec3Add.cpp
//  \brief Source file for the MTL 3D vector/vector addition kernel
//
...
//*************************************************************************************************
/*!\brief MTL 3-dimensional vector/vector addition kernel.
//
...
double vec3vec3add( size_t N, size_t steps )
{
   ...
   ::std::vector< ::mtl::dense_vector<real> > a( N ), b( N ), c( N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " MTL kernel 'vec3vec3add': Time deviation too large!!!\n";
