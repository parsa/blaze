//=================================================================================================
/*!
//  \file src/blas/DMatDVecMult.cpp
//  \brief Source file for the BLAS dense matrix/dense vector multiplication kernel
//
...
double dmatdvecmult( size_t N, size_t steps )
{
   ...
   gemv( CblasRowMajor, CblasNoTrans, N, N, real(1),
