//=================================================================================================
/*!
//  \file src/blas/DMatTDMatMult.cpp
//  \brief Source file for the BLAS dense matrix/transpose dense matrix multiplication kernel
//
...
//*************************************************************************************************
/*!\brief BLAS dense matrix/transpose dense matrix multiplication kernel.
//
...
double dmattdmatmult( size_t N, size_t steps )
{
   ...
   ::blaze::DynamicMatrix<real,rowMajor> A( N, N ), C( N, N );
   ::blaze::DynamicMatrix<real,columnMajor> B( N, N );
   ...
   gemm( CblasRowMajor, CblasNoTrans, CblasTrans, N, N, N, real(1),
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " BLAS kernel 'dmattdmatmult': Time deviation too large!!!\n";
