//=================================================================================================
/*!
//  \file src/blaze/Complex8.cpp
//  \brief Source file for the Blaze kernel for the complex expression C += s * A * B
//
...
//*************************************************************************************************
/*!\brief Blaze kernel for the complex expression C += s * A * B.
//
...
double complex8( size_t N, size_t steps )
{
   ...
   ::blaze::DynamicMatrix<real,columnMajor> A( N, N ), B( N, N ), C( N, N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Blaze kernel 'complex8': Time deviation too large!!!\n";
