...
//  \brief Source file for the Blaze 3D transpose vector/matrix multiplication kernel
//
...
//*************************************************************************************************
/*!\brief Blaze 3-dimensional transpose vector/matrix multiplication kernel.
//
...
double tvec3mat3mult( size_t N, size_t steps )
{
   ...
   ::std::vector< ::blaze::StaticVector<real,3UL,rowVector> > a( N ), b( N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Blaze kernel 'tvec3mat3mult': Time deviation too large!!!\n";
