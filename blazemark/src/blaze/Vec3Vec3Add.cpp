...
//*************************************************************************************************
/*!\brief Blaze 3-dimensional vector/vector addition kernel.
//
...
double vec3vec3add( size_t N, size_t steps )
{
   ...
   ::std::vector< ::blaze::StaticVector<real,3UL,columnVector> > a( N ), b( N ), c( N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Blaze kernel 'vec3vec3add': Time deviation too large!!!\n";
