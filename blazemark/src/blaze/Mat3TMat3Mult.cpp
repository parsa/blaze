...
//  \brief Source file for the Blaze 3D matrix/transpose matrix multiplication kernel
//
...
//*************************************************************************************************
/*!\brief Blaze 3-dimensional matrix/transpose matrix multiplication kernel.
//
...
double mat3tmat3mult( size_t N, size_t steps )
{
   ...
   ::std::vector< ::blaze::StaticMatrix<real,3UL,3UL,rowMajor> > A( N ), C( N );
   ::std::vector< ::blaze::StaticMatrix<real,3UL,3UL,columnMajor> > B( N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Blaze kernel 'mat3tmat3mult': Time deviation too large!!!\n";
