...
//*************************************************************************************************
/*!\brief Blaze kernel for the complex expression d = A * ( a + b + c ).
//
...
double complex2( size_t N, size_t steps )
{
   ...
   ::blaze::DynamicVector<real,columnVector> a( N ), b( N ), c( N ), d( N );
   ...
   if( minTime * ( 1.0 + deviation*0.01 ) < avgTime )
      std::cerr << " Blaze kernel 'complex2': Time deviation too large!!!\n";
