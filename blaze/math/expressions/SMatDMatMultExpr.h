...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific row of the given sparse matrix/dense matrix multiplication.
// \ingroup views
//
// \param dm The constant sparse matrix/dense matrix multiplication.
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
inline typename RowExprTrait< SMatDMatMultExpr<MT1,MT2> >::Type
   row( const SMatDMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific column of the given sparse matrix/dense matrix multiplication.
// \ingroup views
//
// \param dm The constant sparse matrix/dense matrix multiplication.
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
inline typename ColumnExprTrait< SMatDMatMultExpr<MT1,MT2> >::Type
   column( const SMatDMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
