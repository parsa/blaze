...
// \ingroup views
//
// \param dm The constant transpose sparse matrix/dense matrix subtraction.
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
inline typename RowExprTrait< TSMatDMatSubExpr<MT1,MT2> >::Type
   row( const TSMatDMatSubExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
inline typename ColumnExprTrait< TSMatDMatSubExpr<MT1,MT2> >::Type
   column( const TSMatDMatSubExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
