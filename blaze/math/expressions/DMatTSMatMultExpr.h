...
// \ingroup views
//
// \param dm The constant dense matrix/transpose sparse matrix multiplication.
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
inline typename RowExprTrait< DMatTSMatMultExpr<MT1,MT2> >::Type
   row( const DMatTSMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
inline typename ColumnExprTrait< DMatTSMatMultExpr<MT1,MT2> >::Type
   column( const DMatTSMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
