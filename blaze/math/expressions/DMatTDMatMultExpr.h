...
// \ingroup views
//
// \param dm The constant dense matrix/transpose dense matrix multiplication.
...
// matrix/transpose dense matrix multiplication.
*/
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
inline typename RowExprTrait< DMatTDMatMultExpr<MT1,MT2> >::Type
   row( const DMatTDMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
inline typename ColumnExprTrait< DMatTDMatMultExpr<MT1,MT2> >::Type
   column( const DMatTDMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
