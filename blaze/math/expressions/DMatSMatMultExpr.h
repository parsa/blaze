...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific row of the given dense matrix/sparse matrix multiplication.
// \ingroup views
//
// \param dm The constant dense matrix/sparse matrix multiplication.
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
inline typename RowExprTrait< DMatSMatMultExpr<MT1,MT2> >::Type
   row( const DMatSMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific column of the given dense matrix/sparse matrix multiplication.
// \ingroup views
//
// \param dm The constant dense matrix/sparse matrix multiplication.
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
inline typename ColumnExprTrait< DMatSMatMultExpr<MT1,MT2> >::Type
   column( const DMatSMatMultExpr<MT1,MT2>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
