...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific row of the given sparse vector/dense vector outer product.
// \ingroup views
//
// \param sm The constant sparse vector/dense vector outer product.
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
inline typename RowExprTrait< SVecTDVecMultExpr<VT1,VT2> >::Type
   row( const SVecTDVecMultExpr<VT1,VT2>& sm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific column of the given sparse vector/dense vector outer product.
// \ingroup views
//
// \param sm The constant sparse vector/dense vector outer product.
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
inline typename ColumnExprTrait< SVecTDVecMultExpr<VT1,VT2> >::Type
   column( const SVecTDVecMultExpr<VT1,VT2>& sm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
