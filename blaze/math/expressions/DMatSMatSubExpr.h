...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific row of the given dense matrix/sparse matrix subtraction.
// \ingroup views
//
// \param dm The constant dense matrix/sparse matrix subtraction.
...
template< typename MT1  // Type of the left-hand side dense matrix
        , typename MT2  // Type of the right-hand side sparse matrix
        , bool SO >     // Storage order
inline typename RowExprTrait< DMatSMatSubExpr<MT1,MT2,SO> >::Type
   row( const DMatSMatSubExpr<MT1,MT2,SO>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond BLAZE_INTERNAL */
/*!\brief Creating a view on a specific column of the given dense matrix/sparse matrix subtraction.
// \ingroup views
//
// \param dm The constant dense matrix/sparse matrix subtraction.
...
template< typename MT1  // Type of the left-hand side dense matrix
        , typename MT2  // Type of the right-hand side sparse matrix
        , bool SO >     // Storage order
inline typename ColumnExprTrait< DMatSMatSubExpr<MT1,MT2,SO> >::Type
   column( const DMatSMatSubExpr<MT1,MT2,SO>& dm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
