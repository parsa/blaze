                       ...
                       , private Computation
{
 ...
 public:
   ...
   */
   explicit inline SMatTSMatSubExpr( const MT1& lhs, const MT2& rhs )
 ...
 private:
   ...
   */
   ...
   /*! \cond BLAZE_INTERNAL */
   /*!\brief Assignment of a sparse matrix-transpose sparse matrix subtraction to a sparse matrix.
   // \ingroup sparse_matrix
   //
   ...
   */
   ...
   friend inline void assign( SparseMatrix<MT,false>& lhs, const SMatTSMatSubExpr& rhs )
   {
      BLAZE_FUNCTION_TRACE;
   ...
   */
   template< typename MT >  // Type of the target sparse matrix
   friend inline void assign( SparseMatrix<MT,true>& lhs, const SMatTSMatSubExpr& rhs )
   {
      BLAZE_FUNCTION_TRACE;
...
// \ingroup views
//
// \param sm The constant sparse matrix/transpose sparse matrix subtraction.
...
template< typename T1    // Type of the left-hand side sparse matrix
        , typename T2 >  // Type of the right-hand side sparse matrix
inline typename RowExprTrait< SMatTSMatSubExpr<T1,T2> >::Type
   row( const SMatTSMatSubExpr<T1,T2>& sm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
...
template< typename T1    // Type of the left-hand side sparse matrix
        , typename T2 >  // Type of the right-hand side sparse matrix
inline typename ColumnExprTrait< SMatTSMatSubExpr<T1,T2> >::Type
   column( const SMatTSMatSubExpr<T1,T2>& sm, size_t index )
{
   BLAZE_FUNCTION_TRACE;
