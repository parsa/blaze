//=================================================================================================
/*!
//  \file blaze/math/traits/SVecTDVecMultTrait.h
//  \brief Header file for the SVecTDVecMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SVECTDVECMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_SVECTDVECMULTTRAIT_H_
...
struct SVecTDVecMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && !IsTransposeVector<VT1>::value &&
                     ...
                     , SVecTDVecMultExpr<VT1,VT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SVecTDVecMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
