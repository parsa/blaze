//=================================================================================================
/*!
//  \file blaze/math/traits/DMatTDMatMultTrait.h
//  \brief Header file for the DMatTDMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_DMATTDMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_DMATTDMATMULTTRAIT_H_
...
struct DMatTDMatMultTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , DMatTDMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, DMatTDMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
