//=================================================================================================
/*!
//  \file blaze/math/traits/SMatTDMatAddTrait.h
//  \brief Header file for the SMatTDMatAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SMATTDMATADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_SMATTDMATADDTRAIT_H_
...
struct SMatTDMatAddTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , TDMatSMatAddExpr<MT2,MT1>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SMatTDMatAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
