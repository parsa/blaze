//=================================================================================================
/*!
//  \file blaze/math/traits/TDMatSMatMultTrait.h
//  \brief Header file for the TDMatSMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TDMATSMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_TDMATSMATMULTTRAIT_H_
...
struct TDMatSMatMultTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value  && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , TDMatSMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TDMatSMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
