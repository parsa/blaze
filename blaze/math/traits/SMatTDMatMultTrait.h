//=================================================================================================
/*!
//  \file blaze/math/traits/SMatTDMatMultTrait.h
//  \brief Header file for the SMatTDMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SMATTDMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_SMATTDMATMULTTRAIT_H_
...
struct SMatTDMatMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , SMatTDMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SMatTDMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
