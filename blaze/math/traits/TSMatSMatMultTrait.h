//=================================================================================================
/*!
//  \file blaze/math/traits/TSMatSMatMultTrait.h
//  \brief Header file for the TSMatSMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSMATSMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSMATSMATMULTTRAIT_H_
...
struct TSMatSMatMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , TSMatSMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSMatSMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
