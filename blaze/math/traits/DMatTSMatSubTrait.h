//=================================================================================================
/*!
//  \file blaze/math/traits/DMatTSMatSubTrait.h
//  \brief Header file for the DMatTSMatSubTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_DMATTSMATSUBTRAIT_H_
#define _BLAZE_MATH_TRAITS_DMATTSMATSUBTRAIT_H_
...
struct DMatTSMatSubTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value  && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , DMatTSMatSubExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, DMatTSMatSubTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
