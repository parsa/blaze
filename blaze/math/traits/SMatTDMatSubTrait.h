//=================================================================================================
/*!
//  \file blaze/math/traits/SMatTDMatSubTrait.h
//  \brief Header file for the SMatTDMatSubTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SMATTDMATSUBTRAIT_H_
#define _BLAZE_MATH_TRAITS_SMATTDMATSUBTRAIT_H_
...
struct SMatTDMatSubTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , SMatTDMatSubExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SMatTDMatSubTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
