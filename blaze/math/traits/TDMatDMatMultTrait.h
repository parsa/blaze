//=================================================================================================
/*!
//  \file blaze/math/traits/TDMatDMatMultTrait.h
//  \brief Header file for the TDMatDMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TDMATDMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_TDMATDMATMULTTRAIT_H_
...
struct TDMatDMatMultTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , TDMatDMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TDMatDMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
