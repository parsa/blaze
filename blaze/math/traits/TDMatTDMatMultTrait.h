//=================================================================================================
/*!
//  \file blaze/math/traits/TDMatTDMatMultTrait.h
//  \brief Header file for the TDMatTDMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TDMATTDMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_TDMATTDMATMULTTRAIT_H_
...
struct TDMatTDMatMultTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , TDMatTDMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TDMatTDMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
