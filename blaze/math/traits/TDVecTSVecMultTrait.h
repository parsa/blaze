//=================================================================================================
/*!
//  \file blaze/math/traits/TDVecTSVecMultTrait.h
//  \brief Header file for the TDVecTSVecMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TDVECTSVECMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_TDVECTSVECMULTTRAIT_H_
...
struct TDVecTSVecMultTrait
{
 private:
   ...
   typedef SelectType< IsDenseVector<VT1>::value  && IsTransposeVector<VT1>::value &&
                     ...
                     , DVecSVecMultExpr<VT1,VT2,true>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TDVecTSVecMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
