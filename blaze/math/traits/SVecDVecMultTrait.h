//=================================================================================================
/*!
//  \file blaze/math/traits/SVecDVecMultTrait.h
//  \brief Header file for the SVecDVecMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SVECDVECMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_SVECDVECMULTTRAIT_H_
...
struct SVecDVecMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && !IsTransposeVector<VT1>::value &&
                     ...
                     , SVecDVecMultExpr<VT1,VT2,false>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SVecDVecMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
