//=================================================================================================
/*!
//  \file blaze/math/traits/SVecDVecSubTrait.h
//  \brief Header file for the SVecDVecSubTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SVECDVECSUBTRAIT_H_
#define _BLAZE_MATH_TRAITS_SVECDVECSUBTRAIT_H_
...
struct SVecDVecSubTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && !IsTransposeVector<VT1>::value &&
                     ...
                     , SVecDVecSubExpr<VT1,VT2,false>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SVecDVecSubTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
