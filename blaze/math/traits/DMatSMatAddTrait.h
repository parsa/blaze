//=================================================================================================
/*!
//  \file blaze/math/traits/DMatSMatAddTrait.h
//  \brief Header file for the DMatSMatAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_DMATSMATADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_DMATSMATADDTRAIT_H_
...
struct DMatSMatAddTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value  && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , DMatSMatAddExpr<MT1,MT2,false>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, DMatSMatAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
