//=================================================================================================
/*!
//  \file blaze/math/traits/DVecDVecMultTrait.h
//  \brief Header file for the DVecDVecMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_DVECDVECMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_DVECDVECMULTTRAIT_H_
...
struct DVecDVecMultTrait
{
 private:
   ...
   typedef SelectType< IsDenseVector<VT1>::value && !IsTransposeVector<VT1>::value &&
                     ...
                     , DVecDVecMultExpr<VT1,VT2,false>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, DVecDVecMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
