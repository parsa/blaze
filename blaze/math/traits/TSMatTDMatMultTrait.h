//=================================================================================================
/*!
//  \file blaze/math/traits/TSMatTDMatMultTrait.h
//  \brief Header file for the TSMatTDMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSMATTDMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSMATTDMATMULTTRAIT_H_
...
struct TSMatTDMatMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , TSMatTDMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSMatTDMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
