//=================================================================================================
/*!
//  \file blaze/math/traits/TDVecTSVecAddTrait.h
//  \brief Header file for the TDVecTSVecAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TDVECTSVECADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_TDVECTSVECADDTRAIT_H_
...
struct TDVecTSVecAddTrait
{
 private:
   ...
   typedef SelectType< IsDenseVector<VT1>::value  && IsTransposeVector<VT1>::value &&
                     ...
                     , DVecSVecAddExpr<VT1,VT2,true>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TDVecTSVecAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
