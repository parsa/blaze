//=================================================================================================
/*!
//  \file blaze/math/traits/TDMatSMatSubTrait.h
//  \brief Header file for the TDMatSMatSubTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TDMATSMATSUBTRAIT_H_
#define _BLAZE_MATH_TRAITS_TDMATSMATSUBTRAIT_H_
...
struct TDMatSMatSubTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value  && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , TDMatSMatSubExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TDMatSMatSubTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
