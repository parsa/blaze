//=================================================================================================
/*!
//  \file blaze/math/traits/TSMatTDMatSubTrait.h
//  \brief Header file for the TSMatTDMatSubTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSMATTDMATSUBTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSMATTDMATSUBTRAIT_H_
...
struct TSMatTDMatSubTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , SMatDMatSubExpr<MT1,MT2,true>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSMatTDMatSubTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
