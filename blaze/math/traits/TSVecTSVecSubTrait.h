//=================================================================================================
/*!
//  \file blaze/math/traits/TSVecTSVecSubTrait.h
//  \brief Header file for the TSVecTSVecSubTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSVECTSVECSUBTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSVECTSVECSUBTRAIT_H_
...
struct TSVecTSVecSubTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && IsTransposeVector<VT1>::value &&
                     ...
                     , SVecSVecSubExpr<VT1,VT2,true>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSVecTSVecSubTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
