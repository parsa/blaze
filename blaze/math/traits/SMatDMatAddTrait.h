//=================================================================================================
/*!
//  \file blaze/math/traits/SMatDMatAddTrait.h
//  \brief Header file for the SMatDMatAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SMATDMATADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_SMATDMATADDTRAIT_H_
...
struct SMatDMatAddTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , DMatSMatAddExpr<MT2,MT1,false>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SMatDMatAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
