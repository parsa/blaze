//=================================================================================================
/*!
//  \file blaze/math/traits/TSVecDMatMultTrait.h
//  \brief Header file for the TSVecDMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSVECDMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSVECDMATMULTTRAIT_H_
...
struct TSVecDMatMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT>::value && IsTransposeVector<VT>::value &&
                     ...
                     , TSVecDMatMultExpr<VT,MT>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSVecDMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
