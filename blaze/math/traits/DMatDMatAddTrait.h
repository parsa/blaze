//=================================================================================================
/*!
//  \file blaze/math/traits/DMatDMatAddTrait.h
//  \brief Header file for the DMatDMatAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_DMATDMATADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_DMATDMATADDTRAIT_H_
...
struct DMatDMatAddTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , DMatDMatAddExpr<MT1,MT2,false>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, DMatDMatAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
