//=================================================================================================
/*!
//  \file blaze/math/traits/SMatSMatMultTrait.h
//  \brief Header file for the SMatSMatMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SMATSMATMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_SMATSMATMULTTRAIT_H_
...
struct SMatSMatMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseMatrix<MT1>::value && IsRowMajorMatrix<MT1>::value &&
                     ...
                     , SMatSMatMultExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SMatSMatMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
