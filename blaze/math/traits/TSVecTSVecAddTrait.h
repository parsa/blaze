//=================================================================================================
/*!
//  \file blaze/math/traits/TSVecTSVecAddTrait.h
//  \brief Header file for the TSVecTSVecAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSVECTSVECADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSVECTSVECADDTRAIT_H_
...
struct TSVecTSVecAddTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && IsTransposeVector<VT1>::value &&
                     ...
                     , SVecSVecAddExpr<VT1,VT2,true>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSVecTSVecAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
