//=================================================================================================
/*!
//  \file blaze/math/traits/SVecTSVecMultTrait.h
//  \brief Header file for the SVecTSVecMultTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_SVECTSVECMULTTRAIT_H_
#define _BLAZE_MATH_TRAITS_SVECTSVECMULTTRAIT_H_
...
struct SVecTSVecMultTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && !IsTransposeVector<VT1>::value &&
                     ...
                     , SVecTSVecMultExpr<VT1,VT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, SVecTSVecMultTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
