//=================================================================================================
/*!
//  \file blaze/math/traits/TSVecTDVecSubTrait.h
//  \brief Header file for the TSVecTDVecSubTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSVECTDVECSUBTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSVECTDVECSUBTRAIT_H_
...
struct TSVecTDVecSubTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && IsTransposeVector<VT1>::value &&
                     ...
                     , SVecDVecSubExpr<VT1,VT2,true>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSVecTDVecSubTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
