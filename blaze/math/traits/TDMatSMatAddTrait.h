//=================================================================================================
/*!
//  \file blaze/math/traits/TDMatSMatAddTrait.h
//  \brief Header file for the TDMatSMatAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TDMATSMATADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_TDMATSMATADDTRAIT_H_
...
struct TDMatSMatAddTrait
{
 private:
   ...
   typedef SelectType< IsDenseMatrix<MT1>::value  && IsColumnMajorMatrix<MT1>::value &&
                     ...
                     , TDMatSMatAddExpr<MT1,MT2>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TDMatSMatAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
