//=================================================================================================
/*!
//  \file blaze/math/traits/TSVecTDVecAddTrait.h
//  \brief Header file for the TSVecTDVecAddTrait class template
//
...
#ifndef _BLAZE_MATH_TRAITS_TSVECTDVECADDTRAIT_H_
#define _BLAZE_MATH_TRAITS_TSVECTDVECADDTRAIT_H_
...
struct TSVecTDVecAddTrait
{
 private:
   ...
   typedef SelectType< IsSparseVector<VT1>::value && IsTransposeVector<VT1>::value &&
                     ...
                     , DVecSVecAddExpr<VT2,VT1,true>, INVALID_TYPE >  Tmp;
 ...
 public:
   //**********************************************************************************************
   /*! \cond BLAZE_INTERNAL */
   typedef typename SelectType< qualified, TSVecTDVecAddTrait<Type1,Type2>, Tmp >::Type::Type  Type;
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
