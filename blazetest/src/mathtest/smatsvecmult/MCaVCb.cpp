...
int main()
{
   ...
   try
   {
         ...
         for( size_t j=0UL; j<=6UL; ++j ) {
            for( size_t k=0UL; k<=j*i; ++k ) {
               for( size_t l=0UL; l<=i; ++l ) {
                  RUN_SMATSVECMULT_TEST( CMCa( j, i, k ), CVCb( i, l ) );
               }
            }
         }
      }
      ...
      RUN_SMATSVECMULT_TEST( CMCa(  67UL, 127UL, 13UL ), CVCb( 127UL, 13UL ) );
      RUN_SMATSVECMULT_TEST( CMCa( 127UL,  67UL,  7UL ), CVCb(  67UL,  7UL ) );
      RUN_SMATSVECMULT_TEST( CMCa(  64UL, 128UL, 16UL ), CVCb( 128UL, 16UL ) );
      RUN_SMATSVECMULT_TEST( CMCa( 128UL,  64UL,  8UL ), CVCb(  64UL,  8UL ) );
   }
