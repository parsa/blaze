//=================================================================================================
/*!
//  \file src/mathtest/dmatdmatmult/M9x7bM7x9a.cpp
//  \brief Source file for the M9x7bM7x9a dense matrix/dense matrix multiplication math test
//
...
int main()
{
   std::cout << "   Running 'M9x7bM7x9a'..." << std::endl;
   ...
   try
   {
      ...
      // Running the tests
      RUN_DMATDMATMULT_TEST( CM9x7b(), CM7x9a() );
   }
