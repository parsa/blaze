//=================================================================================================
/*!
//  \file src/mathtest/dmatdmatmult/MDaM7x5b.cpp
...
int main()
{
   ...
   try
   {
      ...
      // Running the tests
      RUN_DMATDMATMULT_TEST( CMDa( 5UL, 7UL ), CM7x5b() );
      RUN_DMATDMATMULT_TEST( CMDa( 7UL, 7UL ), CM7x5b() );
      RUN_DMATDMATMULT_TEST( CMDa( 9UL, 7UL ), CM7x5b() );
   }
