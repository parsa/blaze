//=================================================================================================
/*!
//  \file src/mathtest/dmatdmatmult/MDbM5x5a.cpp
...
int main()
{
   ...
   try
   {
      ...
      // Running the tests
      RUN_DMATDMATMULT_TEST( CMDb( 3UL, 5UL ), CM5x5a() );
      RUN_DMATDMATMULT_TEST( CMDb( 5UL, 5UL ), CM5x5a() );
      RUN_DMATDMATMULT_TEST( CMDb( 7UL, 5UL ), CM5x5a() );
   }
