//=================================================================================================
/*!
//  \file src/mathtest/dmatdmatmult/MDbM4x4b.cpp
...
int main()
{
   ...
   try
   {
      ...
      // Running the tests
      RUN_DMATDMATMULT_TEST( CMDb( 3UL, 4UL ), CM4x4b() );
      RUN_DMATDMATMULT_TEST( CMDb( 4UL, 4UL ), CM4x4b() );
      RUN_DMATDMATMULT_TEST( CMDb( 5UL, 4UL ), CM4x4b() );
   }
