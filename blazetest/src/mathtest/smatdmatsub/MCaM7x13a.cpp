...
int main()
{
   ...
   try
   {
      ...
      // Running the tests
      RUN_SMATDMATSUB_TEST( CMCa( 7UL, 13UL,  0UL ), CM7x13a() );
      RUN_SMATDMATSUB_TEST( CMCa( 7UL, 13UL, 30UL ), CM7x13a() );
      RUN_SMATDMATSUB_TEST( CMCa( 7UL, 13UL, 60UL ), CM7x13a() );
      RUN_SMATDMATSUB_TEST( CMCa( 7UL, 13UL, 91UL ), CM7x13a() );
   }
