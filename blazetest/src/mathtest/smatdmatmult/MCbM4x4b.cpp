...
int main()
{
   ...
   try
   {
      ...
      for( size_t i=0UL; i<=6UL; ++i ) {
         RUN_SMATDMATMULT_TEST( CMCb( i, 4UL, 0UL        ), CM4x4b() );
         RUN_SMATDMATMULT_TEST( CMCb( i, 4UL, i*4UL*0.25 ), CM4x4b() );
         RUN_SMATDMATMULT_TEST( CMCb( i, 4UL, i*4UL*0.5  ), CM4x4b() );
         RUN_SMATDMATMULT_TEST( CMCb( i, 4UL, i*4UL*0.75 ), CM4x4b() );
         RUN_SMATDMATMULT_TEST( CMCb( i, 4UL, i*4UL      ), CM4x4b() );
      }
   }
