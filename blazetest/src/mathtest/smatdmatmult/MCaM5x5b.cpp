...
int main()
{
   ...
   try
   {
      ...
      for( size_t i=0UL; i<=7UL; ++i ) {
         RUN_SMATDMATMULT_TEST( CMCa( i, 5UL, 0UL        ), CM5x5b() );
         RUN_SMATDMATMULT_TEST( CMCa( i, 5UL, i*5UL*0.25 ), CM5x5b() );
         RUN_SMATDMATMULT_TEST( CMCa( i, 5UL, i*5UL*0.5  ), CM5x5b() );
         RUN_SMATDMATMULT_TEST( CMCa( i, 5UL, i*5UL*0.75 ), CM5x5b() );
         RUN_SMATDMATMULT_TEST( CMCa( i, 5UL, i*5UL      ), CM5x5b() );
      }
   }
