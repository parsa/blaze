...
int main()
{
   ...
   try
   {
         ...
         for( size_t j=0UL; j<=6UL; ++j ) {
            for( size_t k=0UL; k<=i; ++k ) {
               for( size_t l=0UL; l<=i*j; ++l ) {
                  RUN_TSVECSMATMULT_TEST( CVCa( i, k ), CMCa( i, j, l ) );
               }
            }
         }
      }
      ...
      RUN_TSVECSMATMULT_TEST( CVCa(  67UL,  7UL ), CMCa(  67UL, 127UL, 13UL ) );
      RUN_TSVECSMATMULT_TEST( CVCa( 127UL, 13UL ), CMCa( 127UL,  67UL,  7UL ) );
      RUN_TSVECSMATMULT_TEST( CVCa(  64UL,  8UL ), CMCa(  64UL, 128UL, 16UL ) );
      RUN_TSVECSMATMULT_TEST( CVCa( 128UL, 16UL ), CMCa( 128UL,  64UL,  8UL ) );
   }
