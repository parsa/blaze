...
int main()
{
   ...
   try
   {
      ...
      // Running the tests
      RUN_SMATDMATADD_TEST( CMCa( 16UL, 8UL,   0UL ), CM16x8a() );
      RUN_SMATDMATADD_TEST( CMCa( 16UL, 8UL,  32UL ), CM16x8a() );
      RUN_SMATDMATADD_TEST( CMCa( 16UL, 8UL,  64UL ), CM16x8a() );
      RUN_SMATDMATADD_TEST( CMCa( 16UL, 8UL,  96UL ), CM16x8a() );
      RUN_SMATDMATADD_TEST( CMCa( 16UL, 8UL, 128UL ), CM16x8a() );
   }
