...
int main()
{
   ...
   try
   {
      ...
      // Running the tests
      RUN_DMATSVECMULT_TEST( CM7x13b(), CVCa( 13UL,  0UL ) );
      RUN_DMATSVECMULT_TEST( CM7x13b(), CVCa( 13UL,  4UL ) );
      RUN_DMATSVECMULT_TEST( CM7x13b(), CVCa( 13UL,  8UL ) );
      RUN_DMATSVECMULT_TEST( CM7x13b(), CVCa( 13UL, 13UL ) );
   }
