      ...
      for( size_t i=0UL; i<=8UL; ++i ) {
         for( size_t j=0UL; j<=8UL; ++j ) {
            for( size_t k=0UL; k<=i; ++k ) {
               RUN_SVECTDVECMULT_TEST( CVCa( i, k ), CVDb( j ) );
            }
         }
      }

      // Running tests with large vectors
      RUN_SVECTDVECMULT_TEST( CVCa(  67UL,  7UL ), CVDb(  67UL ) );
      RUN_SVECTDVECMULT_TEST( CVCa(  67UL, 13UL ), CVDb( 127UL ) );
      RUN_SVECTDVECMULT_TEST( CVCa( 127UL,  7UL ), CVDb(  67UL ) );
      RUN_SVECTDVECMULT_TEST( CVCa( 127UL, 13UL ), CVDb( 127UL ) );
      RUN_SVECTDVECMULT_TEST( CVCa(  64UL,  8UL ), CVDb(  64UL ) );
      RUN_SVECTDVECMULT_TEST( CVCa(  64UL, 16UL ), CVDb( 128UL ) );
      RUN_SVECTDVECMULT_TEST( CVCa( 128UL,  8UL ), CVDb(  64UL ) );
      RUN_SVECTDVECMULT_TEST( CVCa( 128UL, 16UL ), CVDb( 128UL ) );
   }
