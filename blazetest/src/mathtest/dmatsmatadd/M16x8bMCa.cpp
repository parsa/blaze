...
int main()
{
   ...
   try
   {
      ...
      // Running the tests
      RUN_DMATSMATADD_TEST( CM16x8b(), CMCa( 16UL, 8UL,   0UL ) );
      RUN_DMATSMATADD_TEST( CM16x8b(), CMCa( 16UL, 8UL,  32UL ) );
      RUN_DMATSMATADD_TEST( CM16x8b(), CMCa( 16UL, 8UL,  64UL ) );
      RUN_DMATSMATADD_TEST( CM16x8b(), CMCa( 16UL, 8UL,  96UL ) );
      RUN_DMATSMATADD_TEST( CM16x8b(), CMCa( 16UL, 8UL, 128UL ) );
   }
