...
int main()
{
   ...
   try
   {
      ...
      for( size_t i=0UL; i<=5UL; ++i ) {
         RUN_DMATSMATMULT_TEST( CM3x3b(), CMCa( 3UL, i, 0UL        ) );
         RUN_DMATSMATMULT_TEST( CM3x3b(), CMCa( 3UL, i, 3UL*i*0.25 ) );
         RUN_DMATSMATMULT_TEST( CM3x3b(), CMCa( 3UL, i, 3UL*i*0.5  ) );
         RUN_DMATSMATMULT_TEST( CM3x3b(), CMCa( 3UL, i, 3UL*i*0.75 ) );
         RUN_DMATSMATMULT_TEST( CM3x3b(), CMCa( 3UL, i, 3UL*i      ) );
      }
   }
