//=================================================================================================
/*!
//  \file src/mathtest/dmatsmatmult/M4x4bMCa.cpp
...
int main()
{
   ...
   try
   {
      ...
      for( size_t i=0UL; i<=6UL; ++i ) {
         RUN_DMATSMATMULT_TEST( CM4x4b(), CMCa( 4UL, i, 0UL        ) );
         RUN_DMATSMATMULT_TEST( CM4x4b(), CMCa( 4UL, i, 4UL*i*0.25 ) );
         RUN_DMATSMATMULT_TEST( CM4x4b(), CMCa( 4UL, i, 4UL*i*0.5  ) );
         RUN_DMATSMATMULT_TEST( CM4x4b(), CMCa( 4UL, i, 4UL*i*0.75 ) );
         RUN_DMATSMATMULT_TEST( CM4x4b(), CMCa( 4UL, i, 4UL*i      ) );
      }
   }
