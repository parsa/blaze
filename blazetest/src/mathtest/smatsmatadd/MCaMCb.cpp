...
int main()
{
   ...
   try
   {
         ...
         for( size_t j=0UL; j<=6UL; ++j ) {
            for( size_t k=0UL; k<=i*j; ++k ) {
               for( size_t l=0UL; l<=i*j; ++l ) {
                  RUN_SMATSMATADD_TEST( CMCa( i, j, k ), CMCb( i, j, l ) );
               }
            }
         }
      }
      ...
      RUN_SMATSMATADD_TEST( CMCa(  67UL,  67UL,  7UL ), CMCb(  67UL,  67UL,  7UL ) );
      RUN_SMATSMATADD_TEST( CMCa(  67UL, 127UL, 13UL ), CMCb(  67UL, 127UL, 13UL ) );
      RUN_SMATSMATADD_TEST( CMCa( 128UL,  64UL,  8UL ), CMCb( 128UL,  64UL,  8UL ) );
      RUN_SMATSMATADD_TEST( CMCa( 128UL, 128UL, 16UL ), CMCb( 128UL, 128UL, 16UL ) );
   }
