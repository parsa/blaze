//=================================================================================================
/*!
//  \file src/mathtest/svecsvecsub/VCaVCb.cpp
      ...
      for( size_t i=0UL; i<=8UL; ++i ) {
         for( size_t j=0UL; j<=i; ++j ) {
            for( size_t k=0UL; k<=i; ++k ) {
               RUN_SVECSVECSUB_TEST( CVCa( i, j ), CVCb( i, k ) );
            }
         }
      }

      // Running tests with large vectors
      RUN_SVECSVECSUB_TEST( CVCa( 127UL, 13UL ), CVCb( 127UL, 13UL ) );
      RUN_SVECSVECSUB_TEST( CVCa( 128UL, 16UL ), CVCb( 128UL, 16UL ) );
   }
