//=================================================================================================
/*!
//  \file src/mathtest/svecsvecsub/VCbVCa.cpp
...
#include <blazetest/mathtest/SVecSVecSub.h>
      ...
      for( size_t i=0UL; i<=8UL; ++i ) {
         for( size_t j=0UL; j<=i; ++j ) {
            for( size_t k=0UL; k<=i; ++k ) {
               RUN_SVECSVECSUB_TEST( CVCb( i, j ), CVCa( i, k ) );
            }
         }
      }

      // Running tests with large vectors
      RUN_SVECSVECSUB_TEST( CVCb( 127UL, 13UL ), CVCa( 127UL, 13UL ) );
      RUN_SVECSVECSUB_TEST( CVCb( 128UL, 16UL ), CVCa( 128UL, 16UL ) );
   }
