//=================================================================================================
/*!
//  \file blazetest/mathtest/TDVecDVecMult.h
//  \brief Header file for the dense vector/dense vector inner product math test
//
...
#ifndef _BLAZETEST_MATHTEST_TDVECDVECMULT_H_
#define _BLAZETEST_MATHTEST_TDVECDVECMULT_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the dense vector/dense vector inner product math test.
//
// The TDVecDVecMult class template represents one particular inner product test between two
...
class TDVecDVecMult
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit TDVecDVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the TDVecDVecMult class template.
//
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side dense vector
TDVecDVecMult<VT1,VT2>::TDVecDVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TDVecDVecMult<VT1,VT2>::testInitialStatus()
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TDVecDVecMult<VT1,VT2>::testAssignment()
{
   try {
      lhs_ = reflhs_;
      rhs_ = refrhs_;
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TDVecDVecMult<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TDVecDVecMult<VT1,VT2>::checkResult()
{
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      TDVecDVecMult<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_TDVECDVECMULT_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::tdvecdvecmult::TDVecDVecMult<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_TDVECDVECMULT_TEST( C1, C2 ) \
   blazetest::mathtest::tdvecdvecmult::runTest( C1, C2 )
/*! \endcond */
//*************************************************************************************************
