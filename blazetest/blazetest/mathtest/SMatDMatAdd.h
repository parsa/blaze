//=================================================================================================
/*!
//  \file blazetest/mathtest/SMatDMatAdd.h
//  \brief Header file for the sparse matrix/dense matrix addition math test
//
...
#ifndef _BLAZETEST_MATHTEST_SMATDMATADD_H_
#define _BLAZETEST_MATHTEST_SMATDMATADD_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the sparse matrix/dense matrix addition math test.
//
// The SMatDMatAdd class template represents one particular matrix addition test between two
...
class SMatDMatAdd
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit SMatDMatAdd( const Creator<MT1>& creator1, const Creator<MT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the SMatDMatAdd class template.
//
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
SMatDMatAdd<MT1,MT2>::SMatDMatAdd( const Creator<MT1>& creator1, const Creator<MT2>& creator2 )
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
void SMatDMatAdd<MT1,MT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
void SMatDMatAdd<MT1,MT2>::testAssignment()
{
   //=====================================================================================
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
void SMatDMatAdd<MT1,MT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
void SMatDMatAdd<MT1,MT2>::testBasicOperation()
{
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
void SMatDMatAdd<MT1,MT2>::testNegatedOperation()
{
...
void SMatDMatAdd<MT1,MT2>::testScaledOperation( T scalar )
{
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
void SMatDMatAdd<MT1,MT2>::testTransposeOperation()
{
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side dense matrix
void SMatDMatAdd<MT1,MT2>::testAbsOperation()
{
...
void SMatDMatAdd<MT1,MT2>::checkResults()
{
...
template< typename LT     // Type of the left-hand side operand
        , typename RT >   // Type of the right-hand side operand
void SMatDMatAdd<MT1,MT2>::checkTransposeResults()
{
   using blaze::IsRowMajorMatrix;
...
void runTest( const Creator<MT1>& creator1, const Creator<MT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      SMatDMatAdd<MT1,MT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_SMATDMATADD_TEST( MT1, MT2 ) \
   extern template class blazetest::mathtest::smatdmatadd::SMatDMatAdd<MT1,MT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_SMATDMATADD_TEST( C1, C2 ) \
