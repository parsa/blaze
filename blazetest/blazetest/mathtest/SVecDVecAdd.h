//=================================================================================================
/*!
//  \file blazetest/mathtest/SVecDVecAdd.h
//  \brief Header file for the sparse vector/dense vector addition math test
//
...
#ifndef _BLAZETEST_MATHTEST_SVECDVECADD_H_
#define _BLAZETEST_MATHTEST_SVECDVECADD_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the sparse vector/dense vector addition math test.
//
// The SVecDVecAdd class template represents one particular vector addition test between two
...
class SVecDVecAdd
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit SVecDVecAdd( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the SVecDVecAdd class template.
//
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
SVecDVecAdd<VT1,VT2>::SVecDVecAdd( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecAdd<VT1,VT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecAdd<VT1,VT2>::testAssignment()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecAdd<VT1,VT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecAdd<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecAdd<VT1,VT2>::testNegatedOperation()
{
...
void SVecDVecAdd<VT1,VT2>::testScaledOperation( T scalar )
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecAdd<VT1,VT2>::testTransposeOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecAdd<VT1,VT2>::testAbsOperation()
{
...
void SVecDVecAdd<VT1,VT2>::checkResults()
{
...
template< typename LT     // Type of the left-hand side operand
        , typename RT >   // Type of the right-hand side operand
void SVecDVecAdd<VT1,VT2>::checkTransposeResults()
{
   using blaze::IsTransposeVector;
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      SVecDVecAdd<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_SVECDVECADD_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::svecdvecadd::SVecDVecAdd<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_SVECDVECADD_TEST( C1, C2 ) \
