//=================================================================================================
/*!
//  \file blazetest/mathtest/DVecSVecMult.h
//  \brief Header file for the dense vector/sparse vector multiplication math test
//
...
#ifndef _BLAZETEST_MATHTEST_DVECSVECMULT_H_
#define _BLAZETEST_MATHTEST_DVECSVECMULT_H_
...
//
// The DVecSVecMult class template represents one particular vector multiplication test between two
...
class DVecSVecMult
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit DVecSVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the DVecSVecMult class template.
//
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
DVecSVecMult<VT1,VT2>::DVecSVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecMult<VT1,VT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecMult<VT1,VT2>::testAssignment()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecMult<VT1,VT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecMult<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecMult<VT1,VT2>::testNegatedOperation()
{
...
void DVecSVecMult<VT1,VT2>::testScaledOperation( T scalar )
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecMult<VT1,VT2>::testTransposeOperation()
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecMult<VT1,VT2>::testAbsOperation()
{
...
void DVecSVecMult<VT1,VT2>::checkResults()
{
...
template< typename LT     // Type of the left-hand side operand
        , typename RT >   // Type of the right-hand side operand
void DVecSVecMult<VT1,VT2>::checkTransposeResults()
{
   using blaze::IsTransposeVector;
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      DVecSVecMult<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_DVECSVECMULT_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::dvecsvecmult::DVecSVecMult<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_DVECSVECMULT_TEST( C1, C2 ) \
