//=================================================================================================
/*!
//  \file blazetest/mathtest/SVecTSVecMult.h
//  \brief Header file for the sparse vector/sparse vector outer product math test
//
...
#ifndef _BLAZETEST_MATHTEST_SVECTSVECMULT_H_
#define _BLAZETEST_MATHTEST_SVECTSVECMULT_H_
...
//
// The SVecTSVecMult class template represents one particular outer product test between two
...
class SVecTSVecMult
{
 private:
   ...
   typedef typename blaze::MathTrait<VT1,TVT2>::MultType  RE;    //!< Default result type
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit SVecTSVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the SVecTSVecMult class template.
//
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
SVecTSVecMult<VT1,VT2>::SVecTSVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::testInitialStatus()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::testAssignment()
{
   try {
      lhs_ = reflhs_;
      rhs_ = refrhs_;
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::testNegatedOperation()
{
...
void SVecTSVecMult<VT1,VT2>::testScaledOperation( T scalar )
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::testTransposeOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::testAbsOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::checkResults()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecTSVecMult<VT1,VT2>::checkTransposeResults()
{
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      SVecTSVecMult<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_SVECTSVECMULT_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::svectsvecmult::SVecTSVecMult<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_SVECTSVECMULT_TEST( C1, C2 ) \
