//=================================================================================================
/*!
//  \file blazetest/mathtest/SVecDVecMult.h
//  \brief Header file for the sparse vector/dense vector multiplication math test
//
...
#ifndef _BLAZETEST_MATHTEST_SVECDVECMULT_H_
#define _BLAZETEST_MATHTEST_SVECDVECMULT_H_
...
//
// The SVecDVecMult class template represents one particular vector multiplication test between two
...
class SVecDVecMult
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit SVecDVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the SVecDVecMult class template.
//
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
SVecDVecMult<VT1,VT2>::SVecDVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecMult<VT1,VT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecMult<VT1,VT2>::testAssignment()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecMult<VT1,VT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecMult<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecMult<VT1,VT2>::testNegatedOperation()
{
...
void SVecDVecMult<VT1,VT2>::testScaledOperation( T scalar )
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecMult<VT1,VT2>::testTransposeOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void SVecDVecMult<VT1,VT2>::testAbsOperation()
{
...
void SVecDVecMult<VT1,VT2>::checkResults()
{
...
void SVecDVecMult<VT1,VT2>::checkTransposeResults()
{
   using blaze::IsTransposeVector;
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      SVecDVecMult<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_SVECDVECMULT_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::svecdvecmult::SVecDVecMult<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_SVECDVECMULT_TEST( C1, C2 ) \
