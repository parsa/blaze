//=================================================================================================
/*!
//  \file blazetest/mathtest/DVecSVecSub.h
...
#ifndef _BLAZETEST_MATHTEST_DVECSVECSUB_H_
#define _BLAZETEST_MATHTEST_DVECSVECSUB_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the dense vector/sparse vector subtraction math test.
//
// The DVecSVecSub class template represents one particular vector subtraction test between two
...
class DVecSVecSub
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit DVecSVecSub( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the DVecSVecSub class template.
//
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
DVecSVecSub<VT1,VT2>::DVecSVecSub( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecSub<VT1,VT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecSub<VT1,VT2>::testAssignment()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecSub<VT1,VT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecSub<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecSub<VT1,VT2>::testNegatedOperation()
{
...
void DVecSVecSub<VT1,VT2>::testScaledOperation( T scalar )
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecSub<VT1,VT2>::testTransposeOperation()
{
...
template< typename VT1    // Type of the left-hand side dense vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void DVecSVecSub<VT1,VT2>::testAbsOperation()
{
...
void DVecSVecSub<VT1,VT2>::checkResults()
{
...
template< typename LT     // Type of the left-hand side operand
        , typename RT >   // Type of the right-hand side operand
void DVecSVecSub<VT1,VT2>::checkTransposeResults()
{
   using blaze::IsTransposeVector;
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      DVecSVecSub<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_DVECSVECSUB_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::dvecsvecsub::DVecSVecSub<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_DVECSVECSUB_TEST( C1, C2 ) \
