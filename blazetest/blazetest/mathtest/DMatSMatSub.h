//=================================================================================================
/*!
//  \file blazetest/mathtest/DMatSMatSub.h
//  \brief Header file for the dense matrix/sparse matrix subtraction math test
//
...
#ifndef _BLAZETEST_MATHTEST_DMATSMATSUB_H_
#define _BLAZETEST_MATHTEST_DMATSMATSUB_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the dense matrix/sparse matrix subtraction math test.
//
// The DMatSMatSub class template represents one particular matrix subtraction test between two
...
class DMatSMatSub
{
 private:
   ...
   typedef typename blaze::MathTrait<MT1,MT2>::SubType  RE;    //!< Default result type
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit DMatSMatSub( const Creator<MT1>& creator1, const Creator<MT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the DMatSMatSub class template.
//
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
DMatSMatSub<MT1,MT2>::DMatSMatSub( const Creator<MT1>& creator1, const Creator<MT2>& creator2 )
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void DMatSMatSub<MT1,MT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void DMatSMatSub<MT1,MT2>::testAssignment()
{
   //=====================================================================================
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void DMatSMatSub<MT1,MT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void DMatSMatSub<MT1,MT2>::testBasicOperation()
{
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void DMatSMatSub<MT1,MT2>::testNegatedOperation()
{
...
void DMatSMatSub<MT1,MT2>::testScaledOperation( T scalar )
{
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void DMatSMatSub<MT1,MT2>::testTransposeOperation()
{
...
template< typename MT1    // Type of the left-hand side dense matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void DMatSMatSub<MT1,MT2>::testAbsOperation()
{
...
void DMatSMatSub<MT1,MT2>::checkResults()
{
...
template< typename LT     // Type of the left-hand side operand
        , typename RT >   // Type of the right-hand side operand
void DMatSMatSub<MT1,MT2>::checkTransposeResults()
{
   using blaze::IsRowMajorMatrix;
...
void runTest( const Creator<MT1>& creator1, const Creator<MT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      DMatSMatSub<MT1,MT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_DMATSMATSUB_TEST( MT1, MT2 ) \
   extern template class blazetest::mathtest::dmatsmatsub::DMatSMatSub<MT1,MT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_DMATSMATSUB_TEST( C1, C2 ) \
