//=================================================================================================
/*!
//  \file blazetest/mathtest/SVecSVecSub.h
//  \brief Header file for the sparse vector/sparse vector subtraction math test
//
...
#ifndef _BLAZETEST_MATHTEST_SVECSVECSUB_H_
#define _BLAZETEST_MATHTEST_SVECSVECSUB_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the sparse vector/sparse vector subtraction math test.
//
// The SVecSVecSub class template represents one particular vector subtraction test between two
...
class SVecSVecSub
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit SVecSVecSub( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the SVecSVecSub class template.
//
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
SVecSVecSub<VT1,VT2>::SVecSVecSub( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecSVecSub<VT1,VT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecSVecSub<VT1,VT2>::testAssignment()
{
   //=====================================================================================
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecSVecSub<VT1,VT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecSVecSub<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecSVecSub<VT1,VT2>::testNegatedOperation()
{
...
void SVecSVecSub<VT1,VT2>::testScaledOperation( T scalar )
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecSVecSub<VT1,VT2>::testTransposeOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side sparse vector
void SVecSVecSub<VT1,VT2>::testAbsOperation()
{
...
void SVecSVecSub<VT1,VT2>::checkResults()
{
...
template< typename LT     // Type of the left-hand side operand
        , typename RT >   // Type of the right-hand side operand
void SVecSVecSub<VT1,VT2>::checkTransposeResults()
{
   using blaze::IsTransposeVector;
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      SVecSVecSub<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_SVECSVECSUB_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::svecsvecsub::SVecSVecSub<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_SVECSVECSUB_TEST( C1, C2 ) \
