//=================================================================================================
/*!
//  \file blazetest/mathtest/DMatDVecMult.h
//  \brief Header file for the dense matrix/dense vector multiplication math test
//
...
#ifndef _BLAZETEST_MATHTEST_DMATDVECMULT_H_
#define _BLAZETEST_MATHTEST_DMATDVECMULT_H_
...
//
// The DMatDVecMult class template represents one particular matrix/vector multiplication test
...
class DMatDVecMult
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit DMatDVecMult( const Creator<MT>& creator1, const Creator<VT>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the DMatDVecMult class template.
//
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
DMatDVecMult<MT,VT>::DMatDVecMult( const Creator<MT>& creator1, const Creator<VT>& creator2 )
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
void DMatDVecMult<MT,VT>::testInitialStatus()
{
   //=====================================================================================
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
void DMatDVecMult<MT,VT>::testAssignment()
{
   //=====================================================================================
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
void DMatDVecMult<MT,VT>::testElementAccess()
{
   using blaze::equal;
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
void DMatDVecMult<MT,VT>::testBasicOperation()
{
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
void DMatDVecMult<MT,VT>::testNegatedOperation()
{
...
void DMatDVecMult<MT,VT>::testScaledOperation( T scalar )
{
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
void DMatDVecMult<MT,VT>::testTransposeOperation()
{
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
void DMatDVecMult<MT,VT>::testAbsOperation()
{
...
void DMatDVecMult<MT,VT>::checkResults()
{
...
template< typename MT    // Type of the left-hand side dense matrix
        , typename VT >  // Type of the right-hand side dense vector
template< typename LT >  // Type of the left-hand side operand
void DMatDVecMult<MT,VT>::checkTransposeResults()
{
   using blaze::IsRowMajorMatrix;
...
void runTest( const Creator<MT>& creator1, const Creator<VT>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      DMatDVecMult<MT,VT>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define RUN_DMATDVECMULT_TEST( C1, C2 ) \
