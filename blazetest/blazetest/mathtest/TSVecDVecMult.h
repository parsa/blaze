//=================================================================================================
/*!
//  \file blazetest/mathtest/TSVecDVecMult.h
//  \brief Header file for the sparse vector/dense vector inner product math test
//
...
#ifndef _BLAZETEST_MATHTEST_TSVECDVECMULT_H_
#define _BLAZETEST_MATHTEST_TSVECDVECMULT_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the sparse vector/dense vector inner product math test.
//
// The TSVecDVecMult class template represents one particular inner product test between two
...
class TSVecDVecMult
{
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit TSVecDVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the TSVecDVecMult class template.
//
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
TSVecDVecMult<VT1,VT2>::TSVecDVecMult( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TSVecDVecMult<VT1,VT2>::testInitialStatus()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TSVecDVecMult<VT1,VT2>::testAssignment()
{
   try {
      lhs_ = reflhs_;
      rhs_ = refrhs_;
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TSVecDVecMult<VT1,VT2>::testBasicOperation()
{
...
template< typename VT1    // Type of the left-hand side sparse vector
        , typename VT2 >  // Type of the right-hand side dense vector
void TSVecDVecMult<VT1,VT2>::checkResult()
{
...
void runTest( const Creator<VT1>& creator1, const Creator<VT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      TSVecDVecMult<VT1,VT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_TSVECDVECMULT_TEST( VT1, VT2 ) \
   extern template class blazetest::mathtest::tsvecdvecmult::TSVecDVecMult<VT1,VT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_TSVECDVECMULT_TEST( C1, C2 ) \
   blazetest::mathtest::tsvecdvecmult::runTest( C1, C2 )
/*! \endcond */
//*************************************************************************************************
