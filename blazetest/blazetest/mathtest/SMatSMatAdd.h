//=================================================================================================
/*!
//  \file blazetest/mathtest/SMatSMatAdd.h
//  \brief Header file for the sparse matrix/sparse matrix addition math test
//
...
#ifndef _BLAZETEST_MATHTEST_SMATSMATADD_H_
#define _BLAZETEST_MATHTEST_SMATSMATADD_H_
...
//*************************************************************************************************
/*!\brief Auxiliary class template for the sparse matrix/sparse matrix addition math test.
//
// The SMatSMatAdd class template represents one particular matrix addition test between two
...
class SMatSMatAdd
{
 private:
   ...
   typedef typename blaze::MathTrait<MT1,MT2>::AddType  RE;    //!< Default result type
 ...
 public:
   ...
   /*!\name Constructors */
   //@{
   explicit SMatSMatAdd( const Creator<MT1>& creator1, const Creator<MT2>& creator2 );
...
//*************************************************************************************************
/*!\brief Constructor for the SMatSMatAdd class template.
//
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
SMatSMatAdd<MT1,MT2>::SMatSMatAdd( const Creator<MT1>& creator1, const Creator<MT2>& creator2 )
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void SMatSMatAdd<MT1,MT2>::testInitialStatus()
{
   //=====================================================================================
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void SMatSMatAdd<MT1,MT2>::testAssignment()
{
   //=====================================================================================
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void SMatSMatAdd<MT1,MT2>::testElementAccess()
{
   using blaze::equal;
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void SMatSMatAdd<MT1,MT2>::testBasicOperation()
{
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void SMatSMatAdd<MT1,MT2>::testNegatedOperation()
{
   ...
   if( BLAZETEST_MATHTEST_TEST_NEGATED_OPERATION > 1 )
   {
      ...
      // Negated addition with subtraction assignment with evaluated matrices
      {
         ...
         try {
            ...
            std::ostringstream oss;
            oss << " Test : " << test_ << "\n"
                << " Error: Failed addition with subtraction assignment operation\n"
                << " Details:\n"
                << "   Left-hand side row-major sparse matrix type:\n"
                << "     " << typeid( MT1  ).name() << "\n"
                << "   Right-hand side column-major sparse matrix type:\n"
...
void SMatSMatAdd<MT1,MT2>::testScaledOperation( T scalar )
{
...
// \exception std::runtime_error Addition error detected.
//
// This function tests the transpose matrix addition with plain assignment, addition assignment,
// and subtraction assignment. In case any error resulting from the addition or the subsequent
// assignment is detected, a \a std::runtime_error exception is thrown.
*/
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void SMatSMatAdd<MT1,MT2>::testTransposeOperation()
{
...
template< typename MT1    // Type of the left-hand side sparse matrix
        , typename MT2 >  // Type of the right-hand side sparse matrix
void SMatSMatAdd<MT1,MT2>::testAbsOperation()
{
...
void SMatSMatAdd<MT1,MT2>::checkResults()
{
...
template< typename LT     // Type of the left-hand side operand
        , typename RT >   // Type of the right-hand side operand
void SMatSMatAdd<MT1,MT2>::checkTransposeResults()
{
   using blaze::IsRowMajorMatrix;
...
void runTest( const Creator<MT1>& creator1, const Creator<MT2>& creator2 )
{
   for( size_t rep=0; rep<repetitions; ++rep ) {
      SMatSMatAdd<MT1,MT2>( creator1, creator2 );
   }
}
//*************************************************************************************************
...
*/
#define DEFINE_SMATSMATADD_TEST( MT1, MT2 ) \
   extern template class blazetest::mathtest::smatsmatadd::SMatSMatAdd<MT1,MT2>
/*! \endcond */
//*************************************************************************************************
...
*/
#define RUN_SMATSMATADD_TEST( C1, C2 ) \
